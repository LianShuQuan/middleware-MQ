...
public class ProductDto {
    ...
    private IdNameTypeDto freightTemplate;
    ...
    public ProductDto(Product product) {
        ...
        this.setfreightTemplate(IdNameTypeDto.builder().id(product.getTemplate().getId()).name(product.getTemplate().getName()).build());
    }
    ...
    public IdNameTypeDto getfreightTemplate(){return freightTemplate;}

    public void setfreightTemplate(IdNameTypeDto freightTemplate) {
