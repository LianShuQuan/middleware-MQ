...
public enum ReturnNo {
    ...
    COUPON_IS_OCCUPIED(693,"优惠卷已被占用"),
    COUPON_IS_USED(694,"优惠卷已被使用"),
    COUPON_NOT_EXIST(695,"优惠卷不存在"),
    POINT_NOT_ENOUGH(692,"积分不足"),
    COUPON_IS_NOT_CHECKED(691,"优惠卷未核销"),
    /**************************************
     *  售后模块
     ************************************/
    ...
    ORDER_INVOKEAPI_ERR(803,"调用%s接口失败，状态码: %d"),
    ONSALE_DUPLICATED(804, "无法创建有重复商品的订单"),
    ORDER_ORDERITEMNOTMATCH(805,"订单商品项不属于本订单"),
    ORDER_OUTSTOCK(806, "订单(id=%s)中有商品库存不足"),
    ORDER_ACTINVALID(807, "订单明细(id=%s)无法享受活动(id=%d)"),
